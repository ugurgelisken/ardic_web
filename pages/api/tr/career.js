export default function handler(req, res) {
  res.status(200).json({
    meta: {
      title: "Kariyer",
      desc: "ARDICTECH'te Kariyer",
    },
    data: {
      cover: "/assets/commons/foots.jpg",
      title_1: "ARDICTECH'te Kariyer",
      text_1:
        "Her zaman statükoyu kırmanın yollarını arayan ve gerçek yüksek teknoloji araştırma ve geliştirmede yeni zeminler arayan motive, girişimci fikirli bireyler arıyoruz. İyi olduğunuza ve sınırlarınız dışına çıkmaya cesaret edebileceğinize inanıyorsanız ve dünya çapındaki teknoloji şirketleriyle aynı ligde oynamayı hedefliyorsanız, o zaman biz sizin için tekiz.",
      title_2: "Açık Pozisyonlar",
      text_2:
        "Lütfen başvurunuzu veya özgeçmişinizi info@ardictech.com adresine gönderin.",
      email: "info@ardictech.com",
      positions: [
        {
          name: "Mobile Developer",
          img: "/assets/career/mobile-developer.jpg",
          detailTexts: [
            {
              tag: "p",
        ...
        },
        {
          ...
          img: "/assets/career/system-and-network-administrator.jpg",
          detailTexts: [
            {
              tag: "p",
        ...
        },
        {
          ...
          img: "/assets/career/backend-developer.jpg",
          detailTexts: [
            {
              tag: "p",
              text: "For more than a decade, we have been building worldwide solutions with pioneering technologies including cloud and mobile services, IoT, and AI. We are looking for new team members with an ambitious mindset and a solid professional or educational background.",
            ...
            {
              tag: "p",
              text: "Experience with REST/stateless API design, RESTful services, and JSON/XML data manipulation * Experience with Java EE, Spring, Springboot frameworks * Experience with PostgreSQL * Experience with messaging queue frameworks (Kafka, Rabbit MQ etc.) * Developer literacy for Linux environment * Knowledge of shell scripting * Knowledge of TCP/UDP, DHCP, DNS * Experience with principles, layered architecture * Familiarity with the following are all pluses: -- Scripting languages (NodeJS, Python, etc.) -- Docker and Kubernetes and Docker Swarm, is a plus -- Redis or a similar in-memory data structure store is a plus",
            },
          ],
        },
        {
          name: "Frontend Developer",
          img: "/assets/career/frontend-developer.jpg",
          detailTexts: [
            {
              tag: "p",
              text: "For more than a decade, we have been building worldwide solutions with pioneering technologies including cloud and mobile services, IoT, and AI. We are looking for new team members with an ambitious mindset and a solid professional or educational background.",
            ...
            {
              tag: "p",
              text: " * Professional experience in web-related design, JavaScript * Knowledge of MVC models, Angular, Bootstrap Foundation * Knowledge of React (Hooks), Context API/Redux, RESTful API * Strength in REST, SOAP, structured and non-structured data models * Experience with WebSocket technologies * Knowledge on TypeScript is a plus * Familiarity with the full web stack, including protocols and web server optimization techniques * Should be able to work with offshore English-speaking team members or stakeholders",
            },
          ],
        },
        {
          name: "Android Framework Developer",
          img: "/assets/career/android-framework-developer.jpg",
          detailTexts: [
            {
              tag: "p",
            ...
            {
              tag: "p",
              text: " * Develop, modify, and integrate additional OS components for Android OEM devices. * Develop, modify, and integrate Android agent applications interacting with the components mentioned above. * Communicate with OEM stakeholders to understand, plan, implement targeted functionalities, and fix issues. * Provide support to business team to evaluate technical requirements, SLAs etc. * Field Support.",
            },
          ],
        },
        {
          name: "Senior React Developer",
          img: "/assets/career/senior-react-developer.jpg",
          detailTexts: [
            {
              tag: "p",
              text: "For more than a decade, we have been building worldwide solutions with pioneering technologies including cloud and mobile services, IoT, and AI. We are looking for new team members with an ambitious mindset and a solid professional or educational background.",
            ...
            {
              tag: "p",
              text: " * Familiarity with desktop/mobile hybrid development platforms (e.g. Electron, Cordova) * Experience on WebRTC or similar real-time communication systems. * Experience on UI testing (unit, integration, end-to-end) * Experience with back-end technologies (e.g. Java, C#) * Experience with Relational or NoSQL databases and Caching Mechanisms",
            },
          ],
        },
      ],
