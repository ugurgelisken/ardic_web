(function () {
  ...
  exports.modules = {
    /***/ 8160: /***/ function (
      ...
      const About = ({ data, meta }) => {
        ...
        const t =
          locale === "en"
            ? _locales_en__WEBPACK_IMPORTED_MODULE_5__ /* .default */.Z
            : _locales_tr__WEBPACK_IMPORTED_MODULE_4__ /* .default */.Z;
        return /*#__PURE__*/ (0,
      ...
      const getServerSideProps = async (router) => {
        const res = await fetch(
          `${"http://localhost:3000"}/api/${router.locale}/about`
        );
  ...
  var __webpack_exports__ = __webpack_require__.X(0, [969], function () {
    return __webpack_exec__(8160);
  });
