...
function handler(req, res) {
  res.status(200).json({
    ...
    data: {
      ...
      summary: "Bağlantılı dünya konusunda tutkulu ve yeni teknolojilerin uygulanmasını kolaylaştıracak yaratıcı çözümler tasarlamaya hevesli 30'dan fazla mühendis.",
      title_1: "Takım Üyeleri ile Tanışın",
      text_1: "Telekomünikasyon kökenlerimiz teknolojik DNA'mızı şekillendirdi ve 100 milyonlarca cihazdan oluşan ağları güvenilir, hızlı ölçeklenebilir ve esnek bir şekilde yönetmek için doğru kültürü ve bilgi birikimini getirdi. Ekibin ABD, Çin ve Avrupa'daki çok kültürlü deneyimleri, çözümlerimizde teknolojiyi kullanma şeklimizi olumlu yönde etkiliyor. Neyin önemli olduğunu biliyoruz ve kaynaklarımızı bunu başarmak için odaklıyoruz.",
      title_2: "Biz kararlı bir ekibiz",
      text_2: "IoT projelerinizin teknolojik ihtiyaçlarına yardımcı olmak ve işinize değer katmak için buradayız. Gömülü sistemler, Android ve Yapay Zeka üzerinde çalışmayı seviyoruz.",
      commons: {
        cupOfCoffe: {
          text: "Fincan Kahve",
          value: "1960768",
      ...
      members: [{
        ...
        linkedin: "https://www.linkedin.com/in/af%C5%9Fin-%C3%A7elik-60830495/"
      }, {
        ...
        linkedin: "https://www.linkedin.com/in/h%C3%BCseyin-metin-par-66576145/"
      }, {
...
var __webpack_exports__ = (__webpack_exec__(7465));
