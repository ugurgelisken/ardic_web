...
function handler(req, res) {
  res.status(200).json({
    meta: {
      title: "Career",
      desc: "Career at ARDICTECH"
    },
    data: {
      cover: "/assets/commons/foots.jpg",
      title_1: "Careers at ARDIC",
      text_1: "We are seeking motivated, entrepreneurial minded individuals who are always looking for ways to break status quo, and cover new grounds in true high-tech research and development. If you believe that you are good and can dare to embark yourself out of your limits, and you aim to play in the same league with world-wide tech companies, then we are the one for you.",
      title_2: "Our Positions",
      text_2: "Please send your application or resume to info@ardictech.com",
