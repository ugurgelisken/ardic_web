...
function handler(req, res) {
  res.status(200).json({
    meta: {
      title: "Technologies",
      desc: "Ignite Cloud, PilarOS, ArCloud, Ignite Edge, AFEX, Machine Learning, Ignite Metrics, Modiverse, Deep Learning, Block Chain"
    },
    data: [{
      name: "Ignite Cloud",
...
var __webpack_exports__ = (__webpack_exec__(5461));
