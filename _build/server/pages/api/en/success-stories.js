...
function handler(req, res) {
  res.status(200).json({
    ...
    data: [{
      ...
      title: "TC Ministry of Finance Revenue Adm. with EMN – Electronic Enquiry Tablet Project",
      detailTexts: [{
        tag: "h4",
        text: "Requirements"
      }, {
      ...
      title: "TC Ministry of Education with SEBIT – FATIH Project for Education – Pilot Implementation",
      detailTexts: [{
        tag: "h4",
        text: "Requirements"
      }, {
